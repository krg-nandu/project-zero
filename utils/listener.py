...
def notify_button_press():
	os.system("espeak -ven+f5 -s190 'Go Ahead'")
...
def voice_error_message():
	os.system("espeak -ven+f5 -s190 'I did not understand that'")

def voice_introduce():
	os.system("espeak -ven+f5 -s190 'My name is zero \n I am still in beta mode'")
def main():
